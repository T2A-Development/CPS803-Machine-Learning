...
def main(train_path, valid_path, save_path):
    ...
    if train_path == 'ds1_train.csv' and valid_path =='ds1_valid.csv':
        util.plot(x_valid, y_valid, clf.theta, 'logreg_1.png')
    else:
        util.plot(x_valid, y_valid, clf.theta, 'logreg_2.png')
